...
def main():
    ...
    # Generate an informational video with a professional teacher
    video_path = generate_info_video(
        teacher_name="Professor Sarah Johnson",
        input_text=educational_content,
        output_path="info_videos/assets/output/updated_climate_change_video.mp4"
    )
    
    if video_path:
        print(f"\n✅ Test successful! Updated video generated at: {video_path}")
    else:
